package not.me.hansolo.custom;

/**
 * from https://harmoniccode.blogspot.com/2010/11/friday-fun-component-iii.html
 * @author hansolo
 */
public class SteelCheckBox extends javax.swing.JCheckBox
{
    private static final long serialVersionUID = 9164755339343352184L;
	// <editor-fold defaultstate="collapsed" desc="Variable declaration">
    private boolean colored = false;
    private boolean rised = false;
    private not.me.hansolo.tools.ColorDef selectedColor = not.me.hansolo.tools.ColorDef.JUG_GREEN;
    ...
    public not.me.hansolo.tools.ColorDef getSelectedColor()
    {
        return this.selectedColor;
    }

    public void setSelectedColor(final not.me.hansolo.tools.ColorDef SELECTED_COLOR)
    {
        final not.me.hansolo.tools.ColorDef OLD_COLOR = this.selectedColor;
